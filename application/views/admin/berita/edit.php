 <div id="layoutSidenav_content">
     <main>
         <div class="container-fluid">
             ...
             <?= form_open_multipart('admin/berita/ubah') ?>
             <div class="card mb-4">
                 ...
                 <div class="card-body">
                     <div class="form-group">
                         ...
                         <input value="<?= $berita['judul']; ?>" name="judul" class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Masukkan Judul" />
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                         <label class="small mb-1" for="inputEmailAddress">Isi Berita</label>
